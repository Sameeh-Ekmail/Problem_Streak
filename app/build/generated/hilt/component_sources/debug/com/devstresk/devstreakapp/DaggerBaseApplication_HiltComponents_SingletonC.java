...
import com.devstresk.devstreakapp.data.di.NetworkModule_ProvideCodeforcesApiServiceFactory;
import com.devstresk.devstreakapp.data.di.NetworkModule_ProvideHttpClientFactory;
import com.devstresk.devstreakapp.data.di.NetworkModule_ProvideUserRepositoryFactory;
...
import com.devstresk.devstreakapp.presentation.UserViewModel_HiltModules;
...
public final class DaggerBaseApplication_HiltComponents_SingletonC {
  ...
  private static final class ActivityCImpl extends BaseApplication_HiltComponents.ActivityC {
    ...
    public Map<Class<?>, Boolean> getViewModelKeys() {
      return LazyClassKeyMap.<Boolean>of(Collections.<String, Boolean>singletonMap(LazyClassKeyProvider.com_devstresk_devstreakapp_presentation_UserViewModel, UserViewModel_HiltModules.KeyModule.provide()));
    }
    ...
    private static final class LazyClassKeyProvider {
      static String com_devstresk_devstreakapp_presentation_UserViewModel = "com.devstresk.devstreakapp.presentation.UserViewModel";

      @KeepFieldType
      UserViewModel com_devstresk_devstreakapp_presentation_UserViewModel2;
    }
  }
  ...
  private static final class ViewModelCImpl extends BaseApplication_HiltComponents.ViewModelC {
    ...
    public Map<Class<?>, javax.inject.Provider<ViewModel>> getHiltViewModelMap() {
      return LazyClassKeyMap.<javax.inject.Provider<ViewModel>>of(Collections.<String, javax.inject.Provider<ViewModel>>singletonMap(LazyClassKeyProvider.com_devstresk_devstreakapp_presentation_UserViewModel, ((Provider) userViewModelProvider)));
    }
    ...
    private static final class SwitchingProvider<T> implements Provider<T> {
      ...
      public T get() {
        switch (id) {
          case 0: // com.devstresk.devstreakapp.presentation.UserViewModel 
          return (T) new UserViewModel(singletonCImpl.provideUserRepositoryProvider.get(), singletonCImpl.userPreferencesProvider.get());
  ...
  private static final class SingletonCImpl extends BaseApplication_HiltComponents.SingletonC {
    ...
    private Provider<CodeforcesApiService> provideCodeforcesApiServiceProvider;
    ...
    private void initialize(final ApplicationContextModule applicationContextModuleParam) {
      ...
      this.provideCodeforcesApiServiceProvider = DoubleCheck.provider(new SwitchingProvider<CodeforcesApiService>(singletonCImpl, 1));
    ...
    private static final class SwitchingProvider<T> implements Provider<T> {
      ...
      public T get() {
        switch (id) {
          case 0: // com.devstresk.devstreakapp.domain.repository.UserRepository 
          return (T) NetworkModule_ProvideUserRepositoryFactory.provideUserRepository(singletonCImpl.provideCodeforcesApiServiceProvider.get());

          case 1: // com.devstresk.devstreakapp.data.remote.CodeforcesApiService 
          return (T) NetworkModule_ProvideCodeforcesApiServiceFactory.provideCodeforcesApiService(singletonCImpl.provideHttpClientProvider.get());

          case 2: // io.ktor.client.HttpClient 
          return (T) NetworkModule_ProvideHttpClientFactory.provideHttpClient();

          case 3: // com.devstresk.devstreakapp.data.local.UserPreferences 
